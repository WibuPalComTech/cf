        ...
        init: function() {
            ...
            checkoutWizard
                .formwizard({
                    ...
                    textSubmit: 'Kirim Ulang Formulir Pendaftaran'
                });
...
function pindahdata(){
	$("#nama_lengkapnya").text("Nama Pemohon : "+document.getElementById("nm_lengkap").value);
	$("#alamat_rumahnya").text("Alamat Pemohon : "+document.getElementById("alamat_rumah").value);
    }