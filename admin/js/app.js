...
var App = function() {
    ...
    var uiInit = function() {
        ...
        if (d.getFullYear() === 2018) { yearCopy.html('2018'); } else { yearCopy.html('2018-' + d.getFullYear().toString()); }
    ...
    return {
        ...
        DP: function() {
            handleDP(); // Datepicker Bootstrap integration
        },
        LB: function() {
            handleLB(); // Datepicker Bootstrap integration
        },				
        datatables: function() {
