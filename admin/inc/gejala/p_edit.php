...
<div class="block full">
  <div class="block-title">
	...
	// meng-update data yang telah di inputkan jika ada pertanyaan yang di inputkan
	$query =  $mysqli->query("UPDATE `gejala` SET `nama_gejala` = '$nama_gejala', `pertanyaan` = '$pertanyaan' WHERE `gejala`.`id_gejala` = '$id';"); 
