...
<table style="border: solid 1px red; width: 105mm">
    <tr><td style="width: 100%; border: solid 1px green; text-align: left; "><?= $phrase; ?></td></tr>
    <tr><td style="width: 100%; border: solid 1px green; text-align: center;"><?= $phrase; ?></td></tr>
    <tr><td style="width: 100%; border: solid 1px green; text-align: right; "><?= $phrase; ?></td></tr>
</table>
<br>
Div :<br>
<div style="width: 103mm; border: solid 1px green; text-align: left; margin: 1mm 0 1mm 0;padding: 1mm;"><?= $phrase; ?></div>
<div style="width: 103mm; border: solid 1px green; text-align: center;margin: 1mm 0 1mm 0;padding: 1mm;"><?= $phrase; ?></div>
<div style="width: 103mm; border: solid 1px green; text-align: right; margin: 1mm 0 1mm 0;padding: 1mm;"><?= $phrase; ?></div>