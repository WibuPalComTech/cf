...
<?php $back = 'background-image: url(./res/off.png); background-position: left top; background-repeat: repeat; '; ?>
    <table style="background: #FFAAAA; color: #000022; border: 3px solid #555555;">
        <tr>
            <td style="width: 40mm; border: solid 1px #000000; <?= $back; ?>color: #003300">Case A1</td>
            <td style="width: 50mm; border: solid 1px #000000; <?= $back; ?>font-weight: bold;">Case A2</td>
            <td style="width: 60mm; border: solid 1px #000000; <?= $back; ?>font-size: 20px;">Case A3</td>
        </tr>
        <tr>
            <td style="border: solid 1px #000000; text-align: left;   <?= $back; ?>vertical-align: top; ">Case B1</td>
            <td style="border: solid 1px #000000; text-align: center; <?= $back; ?>vertical-align: middle; height: 20mm">Case B2<hr style="color: #22AA22">test de hr</td>
            <td style="border: solid 1px #000000; text-align: right;  <?= $back; ?>vertical-align: bottom; border-radius: 3mm; ">Case B3</td>
        </tr>
    </table>
    <br>
