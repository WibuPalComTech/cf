...
?>
                    <tr>
                        <td style="width: 15%; border: solid 1px #000000;"><?= $produit[0];        ?></td>
                        <td style="width: 55%; border: solid 1px #000000;text-align: left;"><?= $produit[1];        ?></td>
                        <td style="width: 15%; border: solid 1px #000000;"><?= $produit[4];        ?></td>
                        <td style="width: 15%; border: solid 1px #000000;"><?= $produit[2]-$produit[4];        ?></td>
                    </tr>
